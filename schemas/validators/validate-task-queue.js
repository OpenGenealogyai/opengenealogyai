...
const SCHEMA_PATH = path.resolve(__dirname, "../task-queue.schema.json");
...
function main() {
  ...
  if (args.length === 0) { console.error("Usage: node validate-task-queue.js <file-or-dir> [...]"); process.exit(1); }
